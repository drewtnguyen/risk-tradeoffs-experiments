...
python3 sims_quantiles_gaussian_cdf.py --nsim $NSIM_Q --ngrid $NGRID
echo "computing bootstrap metrics of quantiles..."
python3 sims_bootstrap_gaussian_cdf.py --nsim $NSIM_B --ngrid $NGRID --nboot $NBOOT
echo "computing all other metrics..."
python3 sims_metrics_gaussian_cdf.py --nsim $NSIM_M --ngrid $NGRID --nboot $NBOOT
